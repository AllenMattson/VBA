Attribute VB_Name = "ScrapeMedlineUpdated_3"
    ...
    With SKUsh
        For r = 0 To trs.Length - 1
            Set tds = trs(r).getElementsByTagName("td")
                ...
                Next C
                SKUsh.Cells(100000, 1).End(xlUp).Offset(1, 7).Value = MyCount
                If tds.Length < 4 Then GoTo ErrCatch
        Next r
    End With
ErrCatch:
